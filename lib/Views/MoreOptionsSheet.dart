...
class MoreOptionsSheet extends StatefulWidget {
  ...
  const MoreOptionsSheet({Key key, this.color, this.date_last_edited, this.callBackColorTapped, this.callBackOptionTapped}) : super(key: key);
...
class _MoreOptionsSheetState extends State<MoreOptionsSheet> {
  ...
  Widget build(BuildContext context) {
    return Container( color: this.note_color,
      child: new Wrap(
        children: <Widget>[
          new ListTile(
          ...
          new Padding(
            ...
            child: SizedBox(
              ...
              child: ColorSlider(
                callBackColorTapped: _changeColor, // call callBack from notePage here
          ...
          new Row(crossAxisAlignment: CrossAxisAlignment.center,
            children: [
              SizedBox(height: 44,child:
              Center(child:  Text(CentralStation.stringForDatetime(widget.date_last_edited) )),
              )
            ],
